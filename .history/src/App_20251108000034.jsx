...
const App = () => {
  ...
  return (
    <div>
      ...
      {/* 🌐 Language Switch */}
      <div className="language-switch absolute top-4 right-6 flex gap-2 z-50">
        <button
          className={`lang px-3 py-1 rounded-md ${
            language === "hi" ? "bg-yellow-500 text-black" : "bg-gray-700 text-white"
          }`}
        ...
        <button
          className={`lang px-3 py-1 rounded-md ${
            language === "en" ? "bg-yellow-500 text-black" : "bg-gray-700 text-white"
          }`}
      ...
      <Routes>
        ...
        <Route path="/events/experiential-learning" element={<ExperientialLearning />} />
        <Route path="/events/internships" element={<Internships />} />
        <Route path="/events/mental-health-and-wellbeing" element={<Mentalhealthandwellbeing />} />
