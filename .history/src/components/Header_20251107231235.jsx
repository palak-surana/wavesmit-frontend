        ...
        <div className="flex flex-col items-end space-y-2">
          ...
          <div className="flex space-x-3">
            <a
              ...
              className="w-6 h-6 bg-gradient-to-r from-pink-400 to-purple-400 hover:from-pink-400 hover:to-purple-400 rounded-full flex items-center justify-center transition-all duration-200 hover:scale-100"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-6 h-6 bg-red-400 hover:bg-red-400 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
            >
          ...
          <button
            ...
            className="bg-[#1a237e] text-white px-3 py-2 rounded-md text-sm hover:bg-[#303f9f] transition"
          >
