              ...
              if (item.link === "/events") {
                return (
                  ...
                  >
                    <Link
                      to="/events"
                      className={`text-white font-semibold text-[15px] uppercase tracking-wide px-3 py-2 hover:text-yellow-400 ${
