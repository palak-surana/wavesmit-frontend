...
const Navbar = () => {
  ...
  return (
<div
  className={`w-screen h-[110px] md:h-[130px] fixed top-0 left-0 right-0 
  ${scrolled ? "shadow-lg shadow-gray-300/50 bg-white" : "bg-white"} 
      ...
      <div className="max-w-[2000px] mx-auto h-full flex flex-row items-center justify-between px-4 md:px-20 lg:px-24">
        ...
        <Link className="flex items-center h-full" to={"/"} onClick={handleLogoClick}>
          <img
            ...
            style={{
  filter: showWave
    ? "brightness(1.1) contrast(1.1)"   // normal color for Wave logo
    : "brightness(1.1) contrast(1.1)",  // normal for NSS too
}}
        ...
        <div className="hidden sm:flex items-center gap-3 ml-auto">
          {Links.map((link) => (
            <Link
              className={`text-black font-normal px-5 py-2 rounded-lg transition-all duration-300 transform active:scale-95
                ${
