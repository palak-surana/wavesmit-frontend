...
const Navbar = () => {
  ...
  return (
    <div
      ...
      ${scrolled ? "shadow-lg shadow-[#2A0E61]/50 bg-[#03001417]" : "bg-transparent"} 
      ...
      <div className="max-w-[2000px] mx-auto h-full flex flex-row items-center justify-between px-4 md:px-20 lg:px-24">
        ...
        <Link className="flex items-center h-full" to={"/"} onClick={handleLogoClick}>
          <img
            ...
            className={`h-12 md:h-16 object-contain drop-shadow-lg transition-opacity duration-700 ease-in-out ${
