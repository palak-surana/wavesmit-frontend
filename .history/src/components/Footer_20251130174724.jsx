          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="w-10 h-10 bg-gradient-to-r from-pink-500 to-purple-500 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-red-600 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
              >
          ...
          <div>
            ...
            <ul className="space-y-3 mt-4">
              {footerLinks.map((link) => (
                <li key={link.name}>
                  <Link to={link.link} className="hover:text-white transition duration-200">
                    {link.name}
                  </Link>
                </li>
              ))}
