        ...
        <div className="flex flex-col items-end space-y-2">
          <div className="flex space-x-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-6 h-6 bg-gradient-to-r from-pink-600 to-purple-600 rounded-full flex items-center justify-center transition-all duration-300"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-6 h-6 bg-red-600 rounded-full flex items-center justify-center transition-all duration-300"
            >
          ...
          <button
            ...
            className="bg-[#1a237e] text-white px-2 py-1 rounded-md text-sm hover:bg-[#303f9f] transition"
          >
              ...
              if (item.link === "/events") {
                return (
                  ...
                  >
                    <Link
                      to="/events"
                      className={`text-white font-semibold text-[15px] uppercase px-3 py-2 hover:text-yellow-400 ${
                    ...
                    {dropdownOpen === "events" && (
                      <ul className="absolute top-full left-0 mt-1 w-56 bg-[#0d1b6b] border border-blue-900 rounded-md shadow-lg py-2 z-50">
                        <li>
                          <Link to="/events/guest-lectures" className="block px-4 py-2 text-white hover:bg-blue-800">
                            Guest Lectures
                          </Link>
                        </li>
                        <li>
                        ...
                        <li>
                          <Link to="/events/social-outreach" className="block px-4 py-2 text-white hover:bg-blue-800">
                            Social Outreach
                          </Link>
                        </li>
                        <li>
                        ...
                        <li>
                          <Link to="/events/experiential-learning" className="block px-4 py-2 text-white hover:bg-blue-800">
                            Experiential Learning
                          </Link>
                        </li>
                        <li>
                          <Link to="/events/internships" className="block px-4 py-2 text-white hover:bg-blue-800">
                            Internships
                          </Link>
                        </li>
                        <li>
                          <Link to="/events/mental-health-and-wellbeing" className="block px-4 py-2 text-white hover:bg-blue-800">
              ...
              if (item.link === "/awards") {
                return (
                  <li
                    key="awards"
                    className="relative group"
                    onMouseEnter={() => setDropdownOpen("awards")}
                    onMouseLeave={() => setDropdownOpen(null)}
                  >
                    <Link
                      to="/awards"
                    ...
                    {dropdownOpen === "awards" && (
                      <ul className="absolute top-full left-0 mt-1 w-56 bg-[#0d1b6b] border border-blue-900 rounded-md shadow-lg py-2 z-50">
                        <li>
                          <Link to="/awards/csr-fund" className="block px-4 py-2 text-white hover:bg-blue-800">
                            CSR Fund
                          </Link>
                        </li>
                        <li>
                          <Link to="/awards/copyright" className="block px-4 py-2 text-white hover:bg-blue-800">
                            Copyright
                          </Link>
                        </li>
                        <li>
                          <Link to="/awards/appreciation-letters" className="block px-4 py-2 text-white hover:bg-blue-800">
              ...
              if (item.link === "/reports") {
                return (
                  <li
                    key="reports"
                    className="relative group"
                    onMouseEnter={() => setDropdownOpen("reports")}
                    onMouseLeave={() => setDropdownOpen(null)}
                  >
                    <Link
                      to="/reports"
