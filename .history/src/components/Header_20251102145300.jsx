...
const Header = () => {
  ...
  return (
    <header className="w-full fixed top-0 left-0 z-50 bg-white">
      {/* ===== Top White Bar (Hindi, Accessibility, A+, A–) ===== */}
      <div className="w-full bg-gray-100 border-b border-gray-300 flex items-center justify-end px-6 py-1 text-[14px] text-gray-700 font-medium space-x-5">
        <span className="cursor-pointer hover:text-[#1a237e]">हिन्दी</span>
        <span className="cursor-pointer hover:text-[#1a237e]">Accessibility</span>
        <span className="cursor-pointer hover:text-[#1a237e]">A+</span>
        <span className="cursor-pointer hover:text-[#1a237e]">A-</span>
      </div>

      {/* ===== White Section (Logo + Welcome Text) ===== */}
      <div className="w-full flex flex-col md:flex-row items-center justify-between px-6 md:px-20 py-4">
        {/* Left: Waves + NSS Combined Logo */}
        <div className="flex items-center justify-center md:justify-start">
          <img
            src="/assets/WavesNSSLogo.png" // <-- make sure this file exists in public/assets/
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="fixed top-[160px] right-0 w-64 h-[calc(100vh-160px)] bg-white z-50 shadow-lg">
