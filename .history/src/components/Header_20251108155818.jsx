        ...
        <div className="flex flex-col items-end space-y-2">
          <div className="flex space-x-3">
            <a
              ...
              className="w-6 h-6 bg-gradient-to-r from-pink-600 to-purple-600 rounded-full flex items-center justify-center"
            >
          ...
          <button
            ...
            className="bg-[#1a237e] text-white px-1 py-1 rounded-md text-sm hover:bg-[#303f9f]"
          >
      ...
      <div className="bg-[#1a237e] flex items-center justify-center">
        <ul className="flex items-center justify-center gap-6 py-3">
          {Links.map((item, index) => {
            ...
            if (label === "Events" || label === "कार्यक्रम") {
              return (
                ...
                >
                  <Link
                    to={item.link}
                    className="text-white font-semibold uppercase px-3 py-2 hover:text-yellow-400"
                  >
                    {label}
                  </Link>
                  {dropdownOpen === "events" && (
            ...
            // Reports Dropdown
            if (label === "Reports" || label === "रिपोर्ट") {
              return (
                <li
                  key={index}
                  className="relative group"
