...
const Navbar = () => {
  ...
  return (
    <div className="w-screen fixed top-0 left-0 right-0 z-50">
      ...
      <div
        className={`w-full bg-white flex flex-col md:flex-row items-center justify-between px-6 md:px-10 py-6 ${
          scrolled ? "shadow-md" : ""
        }`}
      >
        {/* --- Left: Logo --- */}
      ...
      <div className="bg-[#1a237e] flex items-center justify-center h-[50px]">
