...
const Navbar = () => {
  ...
  return (
    <div className="w-screen fixed top-0 left-0 right-0 z-50">
      {/* ===== White logo strip (Taller + Left aligned) ===== */}
      <div
        className={`w-full bg-white flex items-center justify-between px-6 md:px-20 py-8 ${
          scrolled ? "shadow-md" : ""
        }`}
      >
        {/* --- Left: Logo --- */}
        <a href="/" onClick={handleLogoClick} className="flex items-center">
          <img
            ...
            className="h-24 md:h-28 object-contain cursor-pointer transition-transform duration-300"
            style={{
        ...
        {/* --- Right side empty (for future buttons/text) --- */}
