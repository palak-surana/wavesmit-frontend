...
const Navbar = () => {
  ...
  const [dropdownOpen, setDropdownOpen] = useState(null); // 👈 multi-dropdown control
      ...
      >
        ...
        <div className="flex flex-col items-end space-y-2">
          ...
          <button
            ...
            className="bg-[#1a237e] text-white px-1 py-1 rounded-md text-sm hover:bg-[#303f9f] transition"
          >
