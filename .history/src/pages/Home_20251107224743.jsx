...
const Home = () => {
  ...
  return (
    <div className="relative flex flex-col w-full min-h-screen bg-[#040015]">
      ...
      {/* Centered Content */}
      <section className="relative z-10 flex flex-col items-center justify-center text-center min-h-screen px-4 pt-[200px]">
        <h1
          className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white mb-8"
          style={{
            textShadow:
              "0 4px 28px rgba(0,0,0,0.8), 0 2px 8px rgba(0,0,0,0.6)",
          }}
        >
          Welcome to Waves and NSS
        </h1>

        <h2 className="text-2xl sm:text-3xl text-gray-200 mb-12">
