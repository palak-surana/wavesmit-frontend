            ...
            <section className="relative z-10 flex flex-col items-center justify-center min-h-screen pt-[90px]">
                <div className="w-full flex justify-center px-4">
                    <img
                        ...
                        alt="NSS and Wave"
                        className="w-[60%] sm:w-[50%] md:w-[40%] lg:w-[35%] rounded-2xl shadow-lg border border-white/20 hover:scale-[1.03] transition-transform duration-300"
                    />
                </div>
            </section>
        </div>
