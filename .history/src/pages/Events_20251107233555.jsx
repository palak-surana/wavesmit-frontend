...
const Events = () => {
  const eventSections = [
    ...
    },
    {
      ...
      description:
        "Hands-on science through experiments, model-making, and learning by doing.",
      image: "/events/experiential-learning.webp",
      link: "/events/experiential-learning",
    },
    {
      title: "Internships",
      description:
        "Real-world research and industry experience for students through collaborative programs.",
      image: "/events/internships.webp",
      link: "/events/internships",
    },
    {
      title: "Mental Health and Well-being",
      description:
        "Workshops and sessions focusing on mindfulness, stress management, and emotional growth.",
      image: "/events/mental-health.webp",
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 sm:py-16 lg:py-20 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-300 max-w-3xl mx-auto">
            Explore our journey through science, innovation, and community engagement.
          </p>
        </div>
